...
(function (global, factory) {
    ...
    var VariableReassignmentTracker = /** @class */ (function () {
        ...
        VariableReassignmentTracker.prototype.isPathReassigned = function (path) {
    ...
    var LocalVariable = /** @class */ (function (_super) {
        ...
        LocalVariable.prototype.hasEffectsWhenAssignedAtPath = function (path, options) {
            ...
            if (path.length === 0)
                return false;
            return (this.reassignments.isPathReassigned(path.slice(0, path.length - 1)) ||
                (this.init &&
        ...
        LocalVariable.prototype.hasEffectsWhenCalledAtPath = function (path, callOptions, options) {
            if (path.length > MAX_PATH_DEPTH)
                return true;
            return (this.reassignments.isPathReassigned(path) ||
                (this.init &&
                    !options.hasNodeBeenCalledAtPathWithOptions(path, this.init, callOptions) &&
        ...
        LocalVariable.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
            if (path.length > MAX_PATH_DEPTH || (this.included && path.length > 0))
                return true;
            return (this.reassignments.isPathReassigned(path) ||
                (this.init &&
                    !options.hasNodeBeenCalledAtPathWithOptions(path, this.init, callOptions) &&
    ...
    var ObjectExpression$1 = /** @class */ (function (_super) {
        ...
        ObjectExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path, options) {
            ...
            for (var _i = 0, properties_2 = properties; _i < properties_2.length; _i++) {
                ...
                if (property.hasEffectsWhenAccessedAtPath(path.slice(1), options))
                    return true;
            }
            return false;
        };
        ...
        ObjectExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path, callOptions, options) {
            ...
            for (var _i = 0, properties_4 = properties; _i < properties_4.length; _i++) {
                ...
                if (property.hasEffectsWhenCalledAtPath(path.slice(1), callOptions, options))
                    return true;
            }
            return false;
        };
        ...
        ObjectExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
            ...
            for (var _i = 0, properties_6 = properties; _i < properties_6.length; _i++) {
                ...
                if (property.someReturnExpressionWhenCalledAtPath(path.slice(1), callOptions, predicateFunction, options))
                    return true;
            }
            return false;
        };
