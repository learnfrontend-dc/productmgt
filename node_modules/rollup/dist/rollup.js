/*
	Rollup.js v0.59.1
	Wed, 16 May 2018 14:41:32 GMT - commit 6fdc7445218e3fa632fe6a760bd88534c74e918c
...
var VariableReassignmentTracker = /** @class */ (function () {
    ...
    VariableReassignmentTracker.prototype.isPathReassigned = function (path$$1) {
        if (this.reassignedPaths.isReassigned)
            return true;
        var currentProperty = this.reassignedPaths;
        for (var keyIndex = 0; keyIndex < path$$1.length; keyIndex++) {
            var key = path$$1[keyIndex];
            if (currentProperty.hasUnknownReassignedProperty || key === UNKNOWN_KEY)
                return true;
            if (!currentProperty.properties[key])
                return false;
            currentProperty = currentProperty.properties[key];
            if (currentProperty.isReassigned)
                return true;
        }
    };
    VariableReassignmentTracker.prototype.reassignPath = function (path$$1, options) {
        ...
        var currentProperty = this.reassignedPaths;
        for (var keyIndex = 0; keyIndex < path$$1.length; keyIndex++) {
            if (currentProperty.isReassigned || currentProperty.hasUnknownReassignedProperty)
                return;
            var key = path$$1[keyIndex];
            if (key === UNKNOWN_KEY) {
            ...
            currentProperty =
                currentProperty.properties[key] ||
                    (currentProperty.properties[key] = {
                        properties: Object.create(null),
                        isReassigned: false,
                        hasUnknownReassignedProperty: false
...
var LocalVariable = /** @class */ (function (_super) {
    ...
    function LocalVariable(name, declarator, init) {
        ...
        _this.reassignments = new VariableReassignmentTracker(init);
        _this.init = init;
        return _this;
    }
    ...
    LocalVariable.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        if (this.init &&
            ...
            !this.reassignments.isPathReassigned(path$$1)) {
    ...
    LocalVariable.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, options) {
        ...
        return (path$$1.length > MAX_PATH_DEPTH ||
            this.reassignments.isPathReassigned(path$$1.slice(0, path$$1.length - 1)) ||
            (this.init &&
    ...
    LocalVariable.prototype.hasEffectsWhenAssignedAtPath = function (path$$1, options) {
        ...
        if (path$$1.length === 0)
            return false;
        return (this.reassignments.isPathReassigned(path$$1.slice(0, path$$1.length - 1)) ||
            (this.init &&
    ...
    LocalVariable.prototype.hasEffectsWhenCalledAtPath = function (path$$1, callOptions, options) {
        if (path$$1.length > MAX_PATH_DEPTH)
            return true;
        return (this.reassignments.isPathReassigned(path$$1) ||
            (this.init &&
                !options.hasNodeBeenCalledAtPathWithOptions(path$$1, this.init, callOptions) &&
    ...
    LocalVariable.prototype.reassignPath = function (path$$1, options) {
        ...
        if (!options.hasNodeBeenAssignedAtPath(path$$1, this)) {
            this.reassignments.reassignPath(path$$1, options.addAssignedNodeAtPath(path$$1, this));
        }
    };
    LocalVariable.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        if (path$$1.length > MAX_PATH_DEPTH || (this.included && path$$1.length > 0))
            return true;
        return (this.reassignments.isPathReassigned(path$$1) ||
            (this.init &&
                !options.hasNodeBeenCalledAtPathWithOptions(path$$1, this.init, callOptions) &&
...
var BlockStatement$1 = /** @class */ (function (_super) {
    ...
    BlockStatement$$1.prototype.bindImplicitReturnExpressionToScope = function () {
...
var ArrowFunctionExpression$1 = /** @class */ (function (_super) {
    ...
    ArrowFunctionExpression$$1.prototype.bind = function () {
        _super.prototype.bind.call(this);
...
var ObjectExpression$1 = /** @class */ (function (_super) {
    ...
    ObjectExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path$$1, callOptions, options) {
        if (path$$1.length === 0)
            return true;
        var subPath = path$$1[0];
        if (path$$1.length === 1 && typeof subPath === 'string' && objectMembers[subPath]) {
            return false;
        }
        var _a = this.getPossiblePropertiesWithName(path$$1[0], PROPERTY_KINDS_READ, options), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (!hasCertainHit)
    ...
    ObjectExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        ...
        var _a = this.getPossiblePropertiesWithName(subPath, PROPERTY_KINDS_READ, options), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (!hasCertainHit)
            return true;
